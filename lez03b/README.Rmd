---
title: "lez03b: Regressioni lineari"
output: 
...
### La media non vuol dire un accidente di niente:
...
In soldoni, il valore medio è quel valore che mi permette di avere lo stesso risultato se tutti i valori fossero uguali:
